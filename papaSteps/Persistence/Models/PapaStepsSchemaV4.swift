...
enum PapaStepsSchemaV4: VersionedSchema {
    ...
    final class WalkRecord {
        #Index<WalkRecord>([\.startDate], [\.healthKitWorkoutUUID])
        ...
        var healthSourceBundleIdentifier: String?
        var healthImportedAt: Date?
        ...
        init(
            ...
            originRawValue = WalkOrigin.papaSteps.rawValue
            healthSourceName = nil
            healthSourceBundleIdentifier = nil
            healthImportedAt = nil
...
typealias WalkRecord = PapaStepsSchemaV4.WalkRecord
typealias WalkTrackPoint = PapaStepsSchemaV4.WalkTrackPoint
